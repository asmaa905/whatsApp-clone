<template>
  <div class="flex">
    <div class="header w-[420px]">
      <div
        class="bg-[#0f0f0f0 w-full flex justify-between items-center px-3 py-2"
      >
        <img
        ...
        <div class="flex items-center justify-center">
          ...
          <!-- not work -->
          <DotsVeritcalIcon @click="logout" fillColor="#515151" class="cursor-pointer" />
        </div>
      </div>
      <div
        id="search"
        class="bg-white w-full px-2 border-b"
      >
        <div
          class="px-1 m-2 bg-[0f0f0f0] flex items-center justify-center rounded-md"
        >
    ...
    >
      <div class="grid h-screen place-items-center">
        <div>
          ...
          <h1 class="text-[32px] font-light mt-10" style="color:#41525d">
            WhatsApp Web
          </h1>
          <div class="text-[14px] text-gray-600t mt-2" style="color:#667781;">
            <div>

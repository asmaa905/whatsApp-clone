...
var X = class _X {
  ...
  isEqual(t) {
    return t instanceof _X && t.projectId === this.projectId && t.database === this.database;
  }
};
var Z = class _Z {
  constructor(t, e, n) {
  ...
  isEqual(t) {
    return 0 === _Z.comparator(this, t);
  }
  child(t) {
    const e = this.segments.slice(this.offset, this.limit());
    return t instanceof _Z ? t.forEach((t2) => {
      e.push(t2);
...
var xt = class _xt {
   ...
   */
  static now() {
    return _xt.fromMillis(Date.now());
  }
  /**
   ...
   */
  static fromDate(t) {
    return _xt.fromMillis(t.getTime());
  }
  /**
...
var Xt = class _Xt extends Jt {
   ...
   */
  static create(t, e, n) {
    return t.isKeyField() ? "in" === e || "not-in" === e ? this.createKeyFieldInFilter(t, e, n) : new ee(t, e, n) : "array-contains" === e ? new ie(t, n) : "in" === e ? new oe(t, n) : "not-in" === e ? new ue(t, n) : "array-contains-any" === e ? new ce(t, n) : new _Xt(t, e, n);
  }
...
var le = class _le {
  ...
  static min() {
    return new _le(new xt(0, 0));
  }
  static max() {
    return new _le(new xt(253402300799, 999999999));
  }
  compareTo(t) {
...
var fe = class _fe {
  ...
  insert(t, e) {
    return new _fe(this.comparator, this.root.insert(t, e, this.comparator).copy(null, null, we.BLACK, null, null));
  }
  // Returns a copy of the map, with the specified key removed.
  remove(t) {
    return new _fe(this.comparator, this.root.remove(t, this.comparator).copy(null, null, we.BLACK, null, null));
  }
...
var we = class _we {
  constructor(t, e, n, r, s) {
    this.key = t, this.value = e, this.color = null != n ? n : _we.RED, this.left = null != r ? r : _we.EMPTY, this.right = null != s ? s : _we.EMPTY, this.size = this.left.size + 1 + this.right.size;
  }
  // Returns a copy of the current node, optionally replacing pieces of it.
  copy(t, e, n, r, s) {
    return new _we(null != t ? t : this.key, null != e ? e : this.value, null != n ? n : this.color, null != r ? r : this.left, null != s ? s : this.right);
  }
  isEmpty() {
    return false;
  }
  ...
  rotateLeft() {
    const t = this.copy(null, null, _we.RED, null, this.right.left);
    return this.right.copy(null, null, this.color, t, null);
  }
  rotateRight() {
    const t = this.copy(null, null, _we.RED, this.left.right, null);
...
var me = class _me {
  ...
  copy(t) {
    const e = new _me(this.comparator);
    return e.data = t, e;
  }
};
var pe = class {
...
var _e = class __e {
  ...
  isEqual(t) {
    return t instanceof __e && this.key.isEqual(t.key) && this.version.isEqual(t.version) && this.documentType === t.documentType && this.documentState === t.documentState && this.data.isEqual(t.data);
  }
  mutableCopy() {
    return new __e(this.key, this.documentType, this.version, this.readTime, this.createTime, this.data.clone(), this.documentState);
  }
  toString() {
...
var Dn = class _Dn {
  ...
  withConverter(t) {
    return new _Dn(this.firestore, t, this._key);
  }
};
var Fn = class _Fn {
  ...
  withConverter(t) {
    return new _Fn(this.firestore, t, this._query);
  }
};
var xn = class _xn extends Fn {
  /** @hideconstructor */
  constructor(t, e, n) {
  ...
  withConverter(t) {
    return new _xn(this.firestore, t, this._path);
  }
};
function Sn(t, e, ...n) {
...
var Mn = class _Mn {
  ...
  static fromBase64String(t) {
    try {
      return new _Mn(Vt.fromBase64String(t));
    } catch (t2) {
   ...
   */
  static fromUint8Array(t) {
    return new _Mn(Vt.fromUint8Array(t));
  }
  /**
...
var Kn = class _Kn {
  ...
  nt(t) {
    return new _Kn(Object.assign(Object.assign({}, this.settings), t), this.databaseId, this.serializer, this.ignoreUndefinedProperties, this.fieldTransforms, this.fieldMask);
  }
  rt(t) {
    var e;
...
var tr = class _tr extends jn {
  _toFieldTransform(t) {
    return new Oe(t.path, new Fe());
  }
  isEqual(t) {
    return t instanceof _tr;
  }
};
...
var _s = class __s {
  ...
  static createAndSchedule(t, e, n, r, s) {
    const i = Date.now() + n, o = new __s(t, e, i, r, s);
    return o.start(n), o;
  }
  /**
